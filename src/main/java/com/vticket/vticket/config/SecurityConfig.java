...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS = {
            ...
            "/event/categories", "/event/list", "/event/*", "/event/search", "/uploads/**","/event/*/seat-chart","/event/*/seat/**"
    };
...
//        );
        httpSecurity.oauth2ResourceServer(oauth2 -> oauth2.jwt(jwtConfigurer -> jwtConfigurer
                ...
                .authenticationEntryPoint(jwtAuthenticationEntryPoint));//handle exception when token invalid
...
//        jwtAuthenticationConverter.setPrincipalClaimName("username");
    ...
    public CorsConfigurationSource corsConfigurationSource() {
       ...
       //url frontend
        ...
        source.registerCorsConfiguration("/**", configuration); //configuration to all endpoints
        return source;
    }
}
